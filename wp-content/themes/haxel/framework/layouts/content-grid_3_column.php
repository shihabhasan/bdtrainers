...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-4 col-md-6 grid grid_2_column grid_3_column'); ?>>
		...
		<div class="featured-thumb col-md-12">
			<?php if (has_post_thumbnail()) : ?>	
				<a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>"><?php the_post_thumbnail('haxel-pop-thumb'); ?></a>
			<?php else: ?>
				<a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>"><img src="<?php echo get_template_directory_uri()."/assets/images/placeholder2.jpg"; ?>" alt="<?php the_title_attribute() ?>"></a>
			<?php endif; ?>
		</div><!--.featured-thumb-->
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<div class="postedon"><?php haxel_posted_on(); ?></div>
