...
class Haxel_Menu_With_Description extends Walker_Nav_Menu {
...
class Haxel_Menu_With_Icon extends Walker_Nav_Menu {
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
		global $wp_query;
		$indent = ( $depth ) ? str_repeat( "\t", $depth ) : '';
...
if (class_exists('WP_Customize_Control')) {
	class Haxel_WP_Customize_Category_Control extends WP_Customize_Control {
        /**
        ...
        public function render_content() {
            $dropdown = wp_dropdown_categories(
                array(
                    ...
                    'echo'              => 0,
                    'show_option_none'  => __( '&mdash; Select &mdash;', 'haxel' ),
                    'option_none_value' => '0',
                    'selected'          => $this->value(),
                )
            );
