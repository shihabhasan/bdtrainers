 ...
 */
function haxel_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'haxel' ),
		'id'            => 'sidebar-1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 1', 'haxel' ), /* Primary Sidebar for Everywhere else */
		'id'            => 'footer-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title title-font">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 2', 'haxel' ), /* Primary Sidebar for Everywhere else */
		'id'            => 'footer-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title title-font">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 3', 'haxel' ), /* Primary Sidebar for Everywhere else */
		'id'            => 'footer-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title title-font">',
...
add_action( 'widgets_init', 'haxel_widgets_init' );
...
function haxel_scripts() {
	...
	wp_enqueue_style( 'haxel-main-theme-style', get_template_directory_uri() . '/assets/css/main.css' );
