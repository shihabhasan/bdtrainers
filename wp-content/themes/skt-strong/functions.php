...
define('SKT_CREDIT','https://www.sktthemes.net/product-category/free-wordpress-themes/','skt-autocar');
define('SKT_URL','https://www.sktthemes.net','skt-strong');
define('SKT_PRO_THEME_URL','https://www.sktthemes.net/shop/crossfit-wordpress-theme/','skt-strong');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/strong-documentation/','skt-strong');
define('SKT_FREE_THEME_URL','https://www.sktthemes.net/shop/free-corporate-wordpress-theme/','skt-strong');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/strong/','skt-strong');
define('SKT_THEMES','https://www.sktthemes.net/themes/','skt-strong');
