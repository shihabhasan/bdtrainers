...
function fitclub_entry_meta() {
	...
	echo '<div class="entry-meta">';
   	...
   	?>
		...
		if ( $tags_list && get_theme_mod('fitclub_postmeta_tags', '') == '' ) echo $tags_list;
...
function fitclub_layout_class() {
	...
	if( $layout_meta == 'default_layout' ) {
		if( is_page() ) {
			if( $fitclub_default_page_layout == 'right_sidebar' ) { $classes = 'right_sidebar'; }
			elseif( $fitclub_default_page_layout == 'left_sidebar' ) { $classes = 'left-sidebar'; }
			elseif( $fitclub_default_page_layout == 'no_sidebar_full_width' ) { $classes = 'no-sidebar-full-width'; }
			elseif( $fitclub_default_page_layout == 'no_sidebar_content_centered' ) { $classes = 'no-sidebar'; }
		}
		elseif( is_single() ) {
			if( $fitclub_default_post_layout == 'right_sidebar' ) { $classes = 'right_sidebar'; }
			elseif( $fitclub_default_post_layout == 'left_sidebar' ) { $classes = 'left-sidebar'; }
			elseif( $fitclub_default_post_layout == 'no_sidebar_full_width' ) { $classes = 'no-sidebar-full-width'; }
			elseif( $fitclub_default_post_layout == 'no_sidebar_content_centered' ) { $classes = 'no-sidebar'; }
		}
		elseif( $fitclub_default_layout == 'right_sidebar' ) { $classes = 'right_sidebar'; }
		elseif( $fitclub_default_layout == 'left_sidebar' ) { $classes = 'left-sidebar'; }
		elseif( $fitclub_default_layout == 'no_sidebar_full_width' ) { $classes = 'no-sidebar-full-width'; }
		elseif( $fitclub_default_layout == 'no_sidebar_content_centered' ) { $classes = 'no-sidebar'; }
	}
...
function fitclub_sidebar_select() {
   ...
   if( $layout_meta == 'default_layout' ) {
      if( is_page() ) {
         if( $fitclub_default_page_layout == 'right_sidebar' ) { get_template_part('sidebar/right'); }
         elseif ( $fitclub_default_page_layout == 'left_sidebar' ) { get_template_part( 'sidebar/left' ); }
      }
      elseif( is_single() ) {
         if( $fitclub_default_post_layout == 'right_sidebar' ) { get_template_part('sidebar/right'); }
         elseif ( $fitclub_default_post_layout == 'left_sidebar' ) { get_template_part( 'sidebar/left' ); }
      }
      elseif( $fitclub_default_layout == 'right_sidebar' ) { get_template_part('sidebar/right'); }
      elseif ( $fitclub_default_layout == 'left_sidebar' ) { get_template_part( 'sidebar/left' ); }
   }
   elseif( $layout_meta == 'right_sidebar' ) { get_template_part('sidebar/right'); }
   elseif( $layout_meta == 'left_sidebar' ) { get_template_part( 'sidebar/left' ); }
}
endif;
 ...
 */
function fitclub_site_logo_migrate() {
	if ( function_exists( 'the_custom_logo' ) && ! has_custom_logo( $blog_id = 0 ) ) {
		$logo_url = get_theme_mod( 'fitclub_logo' );
