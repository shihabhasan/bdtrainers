	...
	jQuery(".newsmag-required-action-button").click(function () {
		...
		jQuery.ajax({
			...
			beforeSend: function (data, settings) {
				jQuery('.newsmag-tab-pane#actions_required h1').append('<div id="temp_load" style="text-align:center"><img src="' + newsmagWelcomeScreenObject.template_directory + '/inc/libraries/welcome-screen/assets/img/ajax-loader.gif" /></div>');
			},
